...
export function CarritoMobile() {
  ...
  return (
    <div
      className={`fixed right-0 h-full shadow-2xl rounded-l-xl p-4 pb-20 overflow-y-auto border-l transition-colors
            ...
            >
              <div className="mb-2">
                ...
                {esPeso ? (
                  ...
                  >
                    Peso: <strong>{producto.cantidad.toFixed(3)} kg</strong>
                    {" • "}
